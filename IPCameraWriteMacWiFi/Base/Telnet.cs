...
namespace IPCameraWriteMacWiFi.Base {
    public class Telnet<T> where T : class, new() {
        ...
        public Telnet(string host_name, int port, T t) {
            this.host = host_name;
            this.port = port;
            this.testing = t;
        }
        ...
        public string Query(string cmd, int sleep_ms) {
            this.WriteLine(cmd);
        ...
        public bool Query(string cmd, int timeout_sec, params string[] expectations) {
            bool r = false;
            try {
                int delay_ms = 100;
        ...
        public string Query(string cmd, int timeout_sec, int retry_time, params string[] expectations) {
            string data = "";
            bool r = false;
            int c = 0;
